...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "text-gray-500 uppercase px-2 h-6 text-left align-middle font-semibold text-xs", 
        "whitespace-nowrap [&:has([role=checkbox])]:pl-2 [&>[role=checkbox]]:translate-y-[2px]", 
        "[&:has([data-slot=button])]:pl-0 [&>[data-slot=button]]:uppercase [&>[data-slot=button]]:font-semibold [&>[data-slot=button]]:text-xs",
        className,
      )}
      {...props}
    />
