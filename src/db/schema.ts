...
export const listings = pgTable("listings", {
  ...
  minimum_nights_avg_ntm: decimal("minimum_nights_avg_ntm", {
    precision: 15,
    scale: 2,
  }),
  maximum_nights_avg_ntm: decimal("maximum_nights_avg_ntm", {
    precision: 15,
    scale: 2,
  }),
  ...
  estimated_occupancy_l365d: decimal("estimated_occupancy_l365d", {
    precision: 5,
    scale: 2,
  }),
  estimated_revenue_l365d: decimal("estimated_revenue_l365d", {
    precision: 15,
    scale: 2,
  }),
  first_review: date("first_review"),
  last_review: date("last_review"),
  review_scores_rating: decimal("review_scores_rating", {
    precision: 3,
    scale: 2,
  }),
  review_scores_accuracy: decimal("review_scores_accuracy", {
    precision: 3,
    scale: 2,
  }),
  review_scores_cleanliness: decimal("review_scores_cleanliness", {
    precision: 3,
    scale: 2,
  }),
  review_scores_checkin: decimal("review_scores_checkin", {
    precision: 3,
    scale: 2,
  }),
  review_scores_communication: decimal("review_scores_communication", {
    precision: 3,
    scale: 2,
  }),
  review_scores_location: decimal("review_scores_location", {
    precision: 3,
    scale: 2,
  }),
  review_scores_value: decimal("review_scores_value", {
    precision: 3,
    scale: 2,
  }),
