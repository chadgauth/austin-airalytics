...
fs.createReadStream('src/data/listings.csv')
  ...
  .on('end', async () => {
    ...
    const dataToInsert = results.map((row) => ({
      ...
      host_since: row.host_since || null,
      host_location: row.host_location || null,
      host_about: row.host_about || null,
      host_response_time: row.host_response_time || null,
      host_response_rate: row.host_response_rate || null,
      host_acceptance_rate: row.host_acceptance_rate || null,
      host_is_superhost: row.host_is_superhost === 't',
      host_thumbnail_url: row.host_thumbnail_url || null,
      host_picture_url: row.host_picture_url || null,
      host_neighbourhood: row.host_neighbourhood || null,
      host_listings_count: row.host_listings_count ? parseInt(row.host_listings_count) : null,
      host_total_listings_count: row.host_total_listings_count ? parseInt(row.host_total_listings_count) : null,
      host_verifications: row.host_verifications || null,
      host_has_profile_pic: row.host_has_profile_pic === 't',
      host_identity_verified: row.host_identity_verified === 't',
